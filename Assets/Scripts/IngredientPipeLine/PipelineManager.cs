...
namespace IngredientPipeLine
{
    ...
    internal class PipelineManager
    {
        ...
        /// <returns></returns>
        public List<Renderable> GetRenderableList(IngredientList selectedList)
        {
        ...
        private ResourceDictionary IngredientListToResourceList(IngredientList selectedList)
        {
