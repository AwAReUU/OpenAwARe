        ...
        void Start()
        {
            ...
            for (int i = MinPointSize; i <= MaxPointSize; i += Steps)
            {
                if (SpawnType == 0)
                {
                    ...
                    //textMeshPro.font = ResourceLists.Load("Fonts & Materials/LiberationSans SDF", typeof(TextMeshProFont)) as TextMeshProFont;
                ...
                else
                {
                    ...
                    textMesh.font = ResourceLists.Load("Fonts/ARIAL", typeof(Font)) as Font;
